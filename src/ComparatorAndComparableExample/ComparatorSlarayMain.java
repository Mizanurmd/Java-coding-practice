...
public class ComparatorSlarayMain {
public static void main(String[] args) {
	List<Employee>empList = new ArrayList<>();
	empList.add(new Employee(1, "Mizanur Rahman", 2, 30000,32));
	empList.add(new Employee(2, "Mamun Rahman", 2, 40000,30));
	empList.add(new Employee(3, "Rajib Rahman", 4, 30000,35));
	empList.add(new Employee(4, "Tawhidul Islam", 6, 32000,31));
	...
	Collections.sort(empList, new SortedOnSalary());
